{
  ...
  outputs = inputs@{ self, nixpkgs, npmlock2nix, photoprism, flake-utils
    , gomod2nix, flake-compat }:
            ...
            config = with lib;
              mkIf cfg.enable {
                ...
                systemd.services.photoprism = {
                  ...
                  serviceConfig = {
                    User = "photoprism";
                    BindPaths = [ cfg.dataDir ] ++ lib.optionals cfg.mysql [
                      "-/run/mysqld"
                      "-/var/run/mysqld"
                    ];
                    LoadCredential =
